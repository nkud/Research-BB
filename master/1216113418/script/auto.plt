...
set xl "Term"
set yl "Agent"
set title "HasVirus ( 5.26316 [term cycle] / -100 [amplitude])"
set output "HasVirus_last.png";plot [3903:4103] "A_hasVirus.txt" with l  title "has_virus_0" 
...
set xl "Term"
set yl "Agent"
set title "HasImmunity ( 5.18421 [term cycle] / -100 [amplitude])"
set output "HasImmunity_last.png";plot [3903:4103] "A_hasImmunity.txt" with l  title "has_immunity_0" 
...
set xl "Term"
set yl "Agent"
set output "SIR_last.png";plot [3903:4103] "A_hasVirus.txt" using 1:4 with l  title "I"
set output "SIR_last.png";replot "A_hasImmunity.txt" using 1:4 with l  title "R"
set title "SIR_0"
set xl "Term"
set yl "Agent"
set output "SIR_0_last.png";plot [3903:4103] "A_hasVirus.txt" with l  title "I_0" 
set output "SIR_0_last.png";replot "A_hasImmunity.txt" with l  title "R_0" 
set title "SIR_RATIO"
set xl "Term"
set yl "Ratio"
set yrange[0:1]
set output "SIR_RATIO_last.png";plot [3903:4103] "A_hasVirus.txt" using 1:5 with l  title "I/POPULATION"
...
set yl "Ratio"
set yrange[0:1]
set output "SIR_0_RATIO_last.png";plot [3903:4103] "A_hasVirus.txt" using 1:6 with l  title "I_0/POPULATION"
...
set xl "Term"
set yl "Agent"
set output "Contact_last.png";plot [3903:4103] "A_infectionContact.txt" with l  title "contact"
...
set yl "Ratio"
set yrange[0:1]
set output "ContactRatio_last.png";plot [3903:4103] "A_infectionContact.txt" using 1:5 with l  title "ratio"
set autoscale y
set output
