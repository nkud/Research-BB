...
set yl "Agent"
set key box below left
set title "HasVirus ( 42.7121 [term cycle] / -100 [amplitude])"
set output "HasVirus_last.png";plot [12644:12844] "A_hasVirus.txt" with l lw 2  title "has_virus_0" 
...
set yl "Agent"
set key box below left
set title "HasImmunity ( 42.3486 [term cycle] / -100 [amplitude])"
set output "HasImmunity_last.png";plot [12644:12844] "A_hasImmunity.txt" with l lw 2  title "has_immunity_0" 
...
set yl "Agent"
set key box below left
set output "SIR_last.png";plot [12644:12844] "A_hasVirus.txt" using 1:4 with l lw 2  title "I"
set output "SIR_last.png";replot "A_hasImmunity.txt" using 1:4 with l lw 2  title "R"
set title "SIR_0"
set xl "Term"
set yl "Agent"
set key box below left
set output "SIR_0_last.png";plot [12644:12844] "A_hasVirus.txt" with l lw 2  title "I_0" 
...
set key box below left
set yrange[0:1]
set output "SIR_RATIO_last.png";plot [12644:12844] "A_hasVirus.txt" using 1:5 with l lw 2  title "I/POPULATION"
...
set key box below left
set yrange[0:1]
set output "SIR_0_RATIO_last.png";plot [12644:12844] "A_hasVirus.txt" using 1:6 with l lw 2  title "I_0/POPULATION"
...
set yl "Agent"
set key box below left
set output "Contact_last.png";plot [12644:12844] "A_infectionContact.txt" with l lw 2  title "contact"
...
set key box below left
set yrange[0:1]
set output "ContactRatio_last.png";plot [12644:12844] "A_infectionContact.txt" using 1:5 with l lw 2  title "ratio"
set autoscale y
set output
